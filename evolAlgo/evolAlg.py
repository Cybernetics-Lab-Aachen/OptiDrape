...
class AbstractEvolAlg(object):
    ...
    @abstractmethod
    def _calculate_score(self, individuum):
        """Hier wird der score eines Individuums berechnet"""
        raise NotImplementedError("Not Implemented")

    @abstractmethod
    def _selection(self, list_of_individuums, number_of_selected_individuums):
