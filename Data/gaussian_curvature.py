...
def surface_curvature(X, Y, Z):
    ...
    Pmax = np.nan_to_num(H + np.sqrt(H ** 2 - K))
    Pmin = np.nan_to_num(H - np.sqrt(H ** 2 - K))
    return Pmax, Pmin
...
if __name__ == '__main__':
    ...
    print ("maximum curvatures: ", temp1[0])
    print ("minimum curvatures", temp1[1])

    print(temp1[0].__len__(), temp1[1].__len__())
